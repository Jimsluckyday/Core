...
// its plain equivalent -- a real risk here specifically, since this file
// also matches pick.prop_player against propLookup by normalized name.
// NFD-decompose-then-strip-diacritics first, same as every other
// normalize() in this project.
